...
var els = window.document.querySelectorAll('h1.entry-title strong a.js-repo-home-link');
if (els) { insertStatusIcon(els); }

els = window.document.querySelectorAll('.js-repo-list h3.repolist-name a:first-child');
if (els) { insertStatusIcon(els); }


function insertStatusIcon(els) {
    for(var i = 0; i < els.length; i++) {
        _insertStatusIcon(els[i]);
    }
}
 ...
 * icon into the DOM. */
function _insertStatusIcon(el) {
    var project = el.pathname;

    var img = window.document.createElement('img');
    img.src = 'https://secure.travis-ci.org' + project + '.png' + branch;
    ...
    img.onload = function() {
        ...
        document.styleSheets[0].insertRule('.travis-ci{display:inline-block;margin-left:8px;line-height:1em;}', 1);
